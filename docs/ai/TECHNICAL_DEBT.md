...
| 5 | PR-1.2.5 EDD missing | Authentication API requirements are undefined; `/auth/*` endpoints cannot be implemented without approved EDD | Obtain approved PR-1.2.5 EDD and create feature branch from updated main. | Open — Blocking PR-1.2.5 |
